...
class UserPreferences {
	...
	public function getAdminPreference($preference)
	{
		 ...
		 return $this->admin_preference[$preference];
	}
...
class AdminPreference
{
	...
	public function addAdminTree($idst, $idst_admin)
	{
		$query = "INSERT INTO %adm_admin_tree"
	...
	public function addAdminCourse($idst, $idst_admin)
	{
		$query =	"INSERT INTO %adm_admin_course"
					." (id_entry, idst_user, type_of_entry)"
					." VALUES ('".$idst."', '".$idst_admin."', 'course')";

		return sql_query($query);
	}

	public function addAdminCatalogue($idst, $idst_admin)
	{
		$query =	"INSERT INTO %adm_admin_course"
					." (id_entry, idst_user, type_of_entry)"
					." VALUES ('".$idst."', '".$idst_admin."', 'catalogue')";

		return sql_query($query);
	}

	public function addAdminCoursepath($idst, $idst_admin)
	{
		$query =	"INSERT INTO %adm_admin_course"
					." (id_entry, idst_user, type_of_entry)"
					." VALUES ('".$idst."', '".$idst_admin."', 'coursepath')";
