...
$_columns = array(
	...
	array('key' => 'user_profile', 'label' => Lang::t('_ADMIN_RULES', 'adminrules'), 'sortable' => true, 'formatter' => 'AdminManagement.formatUserProfile')
);
...
var AdminManagement = {
	...
	formatUserProfile: function(elLiner, oRecord, oColumn, oData) {
		if (oData === false) {
			elLiner.innerHTML = '<span class="ico-sprite fd_notice"><span>'+AdminManagement.oLangs.get('_NONE')+'</span></span>';
		} else {
