...
if ($GLOBALS['ClassToInstanciate'] == 'QuestionManager')
{
	class QuestionManager
	{
		...
		function QuestionManager()
		{
			...
			$this->numberOfMissingWords = 3;
			$this->weight = 3;

			
			$this->Answer[0] = "a government grant giving the holder an exclusive right to produce a specific invention";
			
			$this->Answer[1] = "first written copy of an idea";
			
			$this->Answer[2] = "a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for";
		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "patent &rarr; a government grant giving the holder an exclusive right to produce a specific invention<br>draft &rarr; first written copy of an idea<br>serendipity &rarr; a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for<br>";
				}
...
<link rel="stylesheet" href="_images/default_css.css" type="text/css"><script type="text/javascript" language="JavaScript" src="_scripts/prototype.js"></script><script type="text/javascript" language="JavaScript" src="_scripts/language.js"></script><script type="text/javascript" language="JavaScript" src="_default_lang/en.js"></script><script type="text/javascript" language="JavaScript" src="_default_lang/en.js"></script><script type="text/javascript" language="JavaScript" src="_lang/en.js"></script><script type="text/javascript" language="JavaScript" src="_scripts/Question.js"></script><script type="text/javascript" language="JavaScript" src="_scripts/OpenPopupImage.js"></script><script type="text/javascript" language="JavaScript" src="_scripts/Bar.js"></script><script type="text/vbscript" language="VBScript">
		...
		AvailableMedia[0] = "B1_W12_D3_shaft1.mp3";
		
		AvailableMedia[1] = "B1_W12_D3_shaft2.mp3";
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Choose the best answer.</i><br><i></i></td>
</tr>
<tr class="Question_text">
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">patent </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M1'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M1"><option value="" <?=$this->IsSelected($bInCorrection, "M1", "")?> ></option><option value="a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for" <?=$this->IsSelected($bInCorrection, "M1", "a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for")?> >a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for</option><option value="a government grant giving the holder an exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M1", "a government grant giving the holder an exclusive right to produce a specific invention")?> >a government grant giving the holder an exclusive right to produce a specific invention</option><option value="first written copy of an idea" <?=$this->IsSelected($bInCorrection, "M1", "first written copy of an idea")?> >first written copy of an idea</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">draft </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M2'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M2"><option value="" <?=$this->IsSelected($bInCorrection, "M2", "")?> ></option><option value="a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for" <?=$this->IsSelected($bInCorrection, "M2", "a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for")?> >a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for</option><option value="a government grant giving the holder an exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M2", "a government grant giving the holder an exclusive right to produce a specific invention")?> >a government grant giving the holder an exclusive right to produce a specific invention</option><option value="first written copy of an idea" <?=$this->IsSelected($bInCorrection, "M2", "first written copy of an idea")?> >first written copy of an idea</option></select></td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">serendipity </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M3'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M3"><option value="" <?=$this->IsSelected($bInCorrection, "M3", "")?> ></option><option value="a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for" <?=$this->IsSelected($bInCorrection, "M3", "a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for")?> >a fortunate accident that produces a valuable or pleasing result that wasn't originally looked for</option><option value="a government grant giving the holder an exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M3", "a government grant giving the holder an exclusive right to produce a specific invention")?> >a government grant giving the holder an exclusive right to produce a specific invention</option><option value="first written copy of an idea" <?=$this->IsSelected($bInCorrection, "M3", "first written copy of an idea")?> >first written copy of an idea</option></select></td>
</tr>
</table></p>
