...
if ($GLOBALS['ClassToInstanciate'] == 'QuestionManager')
{
	class QuestionManager
	{
		...
		function QuestionManager()
		{
			...
			$this->Answer[3] = false;
			$this->AnswersWeight[3] = -1 -0;
			
			$this->Answer[4] = false;
			$this->AnswersWeight[4] = -1 -0;
		...
		function GetScore()
		{
			...
			if (isset($_GET["QCM"]))
			{
				for($j = 0; $j < count($_GET["QCM"]); $j++)
					$UserAnswers[$_GET["QCM"][$j]] = true;
			}
			...
			if ($this->ScoringMethod == "AllRight")
			{
				...
				for($j = 0; $j < count($this->Answer); $j++)
					if ($UserAnswers[$j] != $this->Answer[$j])
						return 0;
			}
			else if ($this->ScoringMethod == "UserDefined")
			{
				$MaxRowWeight = 0;
		
				for($j = 0; $j < count($this->Answer); $j++)
				{
					if ($this->AnswersWeight[$j] > 0)
						$MaxRowWeight += $this->AnswersWeight[$j];

					$RowWeight = $this->AnswersWeight[$j];
	...
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function GetQuestionsArray()
		{
			...
			$ret[] = array('correct' => true,
									   'html' => "The tired girl indulged her cravings and bought some chocolate."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "We will indulge the dinner."
			);			
			
			$ret[] = array('correct' => true,
									   'html' => "Tom indulged his wife's wishes and took her on vacation."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "The indulged treat was too rich for the old man."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "We will indulge the business deal this afternoon."
			);			
		...
		function echoCorrectAnswer($bInCorrection, $Column)
		{
			...
			if (isset($Answers["QCM"]))
				for($j = 0; $j < count($Answers["QCM"]); $j++)
					$UserAnswers[$Answers["QCM"][$j]] = true;
		...
		function IsSelected($bInCorrection, $Column)
		{
			...
			if (isset($Answers["QCM"]))
			{
				...
				return ($UserAnswers[$Column]) ? "checked" : "";
			}
			else
				return "";
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Which sentences use the word 'indulge' correctly?</i></td>
</tr>
<tr class="Question_text">
...
<tr class="AnswerRow1">
<td class="Question_answers" valign="top" align="center" width="50"><?$this->echoCorrectAnswer($bInCorrection, 0); ?><input id="Q1" type="checkbox" name="QCM[]" value="0" <?=$this->IsSelected($bInCorrection, 0) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">The tired girl indulged her cravings and bought some chocolate. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers" valign="top" align="center" width="50"><?$this->echoCorrectAnswer($bInCorrection, 1); ?><input id="Q2" type="checkbox" name="QCM[]" value="1" <?=$this->IsSelected($bInCorrection, 1) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">We will indulge the dinner. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers" valign="top" align="center" width="50"><?$this->echoCorrectAnswer($bInCorrection, 2); ?><input id="Q3" type="checkbox" name="QCM[]" value="2" <?=$this->IsSelected($bInCorrection, 2) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">Tom indulged his wife's wishes and took her on vacation. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers" valign="top" align="center" width="50"><?$this->echoCorrectAnswer($bInCorrection, 3); ?><input id="Q4" type="checkbox" name="QCM[]" value="3" <?=$this->IsSelected($bInCorrection, 3) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">The indulged treat was too rich for the old man. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers" valign="top" align="center" width="50"><?$this->echoCorrectAnswer($bInCorrection, 4); ?><input id="Q5" type="checkbox" name="QCM[]" value="4" <?=$this->IsSelected($bInCorrection, 4) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">We will indulge the business deal this afternoon. </td><td valign="top" class="Question_answers">
</td>
</tr>
</table></p>
