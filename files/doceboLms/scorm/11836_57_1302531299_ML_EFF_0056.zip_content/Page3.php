...
if ($GLOBALS['ClassToInstanciate'] == 'QuestionManager')
{
	class QuestionManager
	{
		...
		function QuestionManager()
		{
			...
			$this->Answer[0] = "driver";
			
			$this->Answer[1] = "drive";
			
			$this->Answer[2] = "backseat";
		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "Sunday ____ &rarr; driver<br>____ home &rarr; drive<br>____ driver &rarr; backseat<br>____ by the seat of one's pants &rarr; fly<br>";
				}
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">Sunday ____ </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M1'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M1"><option value="" <?=$this->IsSelected($bInCorrection, "M1", "")?> ></option><option value="backseat" <?=$this->IsSelected($bInCorrection, "M1", "backseat")?> >backseat</option><option value="drive" <?=$this->IsSelected($bInCorrection, "M1", "drive")?> >drive</option><option value="driver" <?=$this->IsSelected($bInCorrection, "M1", "driver")?> >driver</option><option value="fly" <?=$this->IsSelected($bInCorrection, "M1", "fly")?> >fly</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">____ home </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M2'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M2"><option value="" <?=$this->IsSelected($bInCorrection, "M2", "")?> ></option><option value="backseat" <?=$this->IsSelected($bInCorrection, "M2", "backseat")?> >backseat</option><option value="drive" <?=$this->IsSelected($bInCorrection, "M2", "drive")?> >drive</option><option value="driver" <?=$this->IsSelected($bInCorrection, "M2", "driver")?> >driver</option><option value="fly" <?=$this->IsSelected($bInCorrection, "M2", "fly")?> >fly</option></select></td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">____ driver </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M3'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M3"><option value="" <?=$this->IsSelected($bInCorrection, "M3", "")?> ></option><option value="backseat" <?=$this->IsSelected($bInCorrection, "M3", "backseat")?> >backseat</option><option value="drive" <?=$this->IsSelected($bInCorrection, "M3", "drive")?> >drive</option><option value="driver" <?=$this->IsSelected($bInCorrection, "M3", "driver")?> >driver</option><option value="fly" <?=$this->IsSelected($bInCorrection, "M3", "fly")?> >fly</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">____ by the seat of one's pants </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M4'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M4"><option value="" <?=$this->IsSelected($bInCorrection, "M4", "")?> ></option><option value="backseat" <?=$this->IsSelected($bInCorrection, "M4", "backseat")?> >backseat</option><option value="drive" <?=$this->IsSelected($bInCorrection, "M4", "drive")?> >drive</option><option value="driver" <?=$this->IsSelected($bInCorrection, "M4", "driver")?> >driver</option><option value="fly" <?=$this->IsSelected($bInCorrection, "M4", "fly")?> >fly</option></select></td>
</tr>
</table></p>
