...
EpiLang.CorrectionString = "Review";
EpiLang.CorrectionModeString = "Correction Mode";
EpiLang.CorrectionTextHead = "<span class=\"answerkey\">Answer key:</span>";

EpiLang.Warning1String = "You must do the questionnaire from start to finish.";
...
EpiLang.EnterPasswdString = "Please enter the lesson's password:";

EpiLang.TimerFinished = "No time left!";
EpiLangJS.ItIsNotAllowedToGoBack = "You are not allowed to go back!";
EpiLangJS.TheQuizzIsFinished = "The lesson is finished...!";
...
EpiLangJS.YouMustAnswerAllQuestionsBeforeFinishing = "You must answer all of the questions before you can finish.";
EpiLangJS.YouHaveReachTheLastPageButHanventAnsweredAllQuestions = "You have reached the last page, but have not answered all the questions. Do you want to end the lesson now ?";
EpiLangJS.YouHanventAnsweredAllQuestions = "You have not answered all the questions. Do you want to end the lesson now ?";
EpiLangJS.DoYouWantToEndTheQuestionnaireNow = "Do you want to end the lesson now ?";
EpiLang.EndTheQuestionnaireNow = "- End the lesson now -";*/

EpiLangJS.YouHaveReachTheLastPage = "Vous avez atteint la dernière page, voulez-vous terminer maintenant ?";
EpiLangJS.YouMustAnswerAllQuestionsBeforeFinishing = "Vous devez répondre à toutes les questions avant de pouvoir continuer.";
EpiLangJS.YouHaveReachTheLastPageButHanventAnsweredAllQuestions = "Vous avez atteint la dernière page mais n'avez pas répondu à toutes les questions. \n\nVoulez-vous valider votre questionnaire maintenant ? \n\nSi vous cliquez sur \"OK\", vous n'aurez plus la possibilité de revenir sur ces questions.";
EpiLangJS.YouHanventAnsweredAllQuestions = "Vous n'avez pas répondu à toutes les questions. \nVoulez-vous valider votre questionnaire maintenant ? \n\nSi vous cliquez sur \"OK\", vous n'aurez plus la possibilité de revenir sur ces questions. ";
EpiLangJS.DoYouWantToEndTheQuestionnaireNow = "Êtes-vous sûr de vouloir mettre fin au questionnaire ?";
EpiLang.EndTheQuestionnaireNow = "- End the lesson now -";

EpiLang.ErrorWritingUserdata = "<b>Error: </b>Could not write to admin/userdata.php. Please check Apache's rights on the questionnaire folder.";

// reports
// admin.php
EpiLang.QuizReport = "Questionnaire report:";
...
EpiLang.TimeSpentOnTheQuiz = "Time spent on the questionnaire:";
EpiLang.min = "min.";
EpiLang.sec = "sec.";
