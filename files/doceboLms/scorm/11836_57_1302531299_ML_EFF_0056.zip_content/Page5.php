...
else
{
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function QuestionDisplayer()
		{
			...
			$this->AnswerText .= "1. Ralph always tells people how to do things.  He is a <u>backseat</u> driver.<br><br>2. My husband is a terrible <u>Sunday</u> driver.  He drives so slowly!<br><br>3. Jill always sounds like she just fell off the <u>turnip</u> truck.<br><br>4. We really don't have any plans. We'll probably just fly by the <u>seat</u> of our pants.";
...
<td class="Question_text ProcessInlineImages" valign="top"><i>The following sentences use the expressions you just learned but a word is missing.  Write the word in the blank.</i></td>
</tr>
<tr class="Question_text">
<td class="Question_text" align="center" valign="top">
</td></tr>
</table></b></p>
<p class="nswr"><span id="Question_answers" class="Question_answers ProcessInlineImages" style="line-height: 2em">1. Ralph always tells people how to do things.  He is a <?php 
$this->echoCorrectAnswer($bInCorrection, 'T1');				
echo '<input type="text" ';

echo ' name="T1" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T1')).'">';
?> driver.<br><br>2. My husband is a terrible <?php 
$this->echoCorrectAnswer($bInCorrection, 'T2');				
echo '<input type="text" ';

echo ' name="T2" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T2')).'">';
?> driver.  He drives so slowly!<br><br>3. Jill always sounds like she just fell off the <?php 
$this->echoCorrectAnswer($bInCorrection, 'T3');				
echo '<input type="text" ';

echo ' name="T3" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T3')).'">';
?> truck.<br><br>4. We really don't have any plans. We'll probably just fly by the <?php 
