...
if ($GLOBALS['ClassToInstanciate'] == 'QuestionManager')
{
	class QuestionManager
	{
		...
		{
			$this->NumberOfQuestions = 5; // more than one means a tabular QCM/QCU
			$this->ScoringMethod = "";
			$this->inQCUMode = true;
			$this->weight = 5;
			...
			$this->Answer[2][0] = true;
			
			$this->Answer[2][1] = false;
...
else
{
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">I agree <b>that the teacher</b> was a little mean today.</td>";
					...
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "not a noun clause<br>";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\"><b>What is</b> that noise?</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					...
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">Do you know <b>which restaurant they are going to for dinner</b>?</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "complete noun clause<br>";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">I reminded her <b>that she had a dentist appointment today at noon</b>.</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					...
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\"><b>That Jake is jealous of Billy</b> is obvious to everyone.</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
		...
		function echoCorrectAnswer($bInCorrection, $QuestionNumber, $Column)
		{
			...
			$NumberOfQuestions = 5; // more than one means a tabular QCM/QCU
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Are the words in bold a complete noun clause?</i></td>
</tr>
<tr class="Question_text">
...
<th class="Question_answers ProcessInlineImages" align="center">complete noun clause</th>
<th class="Question_answers ProcessInlineImages" align="center">not a noun clause</th>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">I agree <b>that the teacher</b> was a little mean today.</td>
...
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages"><b>What is</b> that noise?</td>
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">Do you know <b>which restaurant they are going to for dinner</b>?</td>
...
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">I reminded her <b>that she had a dentist appointment today at noon</b>.</td>
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages"><b>That Jake is jealous of Billy</b> is obvious to everyone.</td>
