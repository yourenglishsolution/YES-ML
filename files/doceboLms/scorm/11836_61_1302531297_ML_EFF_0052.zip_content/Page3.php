	...
	class QuestionManager
	{
		...
		function QuestionManager()
		{
			...
			$anArray = Array();
					...
					$anArray[0] = trim("Although Brad couldn't swim");
			...
			$anArray = Array();
					...
					$anArray[0] = trim("so that they don't go bad");
			...
			$anArray = Array();
					...
					$anArray[0] = trim("Because he has problems with his hearing");
			...
			$anArray = Array();
					...
					$anArray[0] = trim("If you buy a sports car");
			...
			$anArray = Array();
					...
					$anArray[0] = trim("After the party");
			...
			$anArray = Array();
					...
					$anArray[0] = trim("Although Simon is on vacation right now");
...
else
{
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function QuestionDisplayer()
		{
			...
			$this->AnswerText .= "For Example:<br><i>Fred works as a chef although he doesn't really like to eat. <u>although he doesn't really like to eat.</i></u><br><br>1. Although Brad couldn&rsquo;t swim, he jumped off the cliff.  <u>Although Brad couldn't swim</u><br><br>2. She keeps her eggs in the refrigerator so that they don't go bad.  <u>so that they don't go bad</u><br><br>3. Because he has problems with his hearing, James always sits in the front row of movie theaters.  <u>Because he has problems with his hearing</u><br><br>4. If you buy a sports car, you will have to pay more for your insurance.  <u>If you buy a sports car</u><br><br>5. After the party, Sylvia was very tired.  <u>After the party</u><br><br>6. Although Simon is on vacation right now, he will start working on the new project in two days.  <u>Although Simon is on vacation right now</u>";
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Write the complete adverb clause in the blank after the sentence.</i></td>
</tr>
<tr class="Question_text">
<td class="Question_text" align="center" valign="top">
</td></tr>
</table></b></p>
<p class="nswr"><span id="Question_answers" class="Question_answers ProcessInlineImages" style="line-height: 2em">For Example:<br><i>Fred works as a chef although he doesn't really like to eat. <u>although he doesn't really like to eat.</i></u><br><br>1. Although Brad couldn&rsquo;t swim, he jumped off the cliff.  <?php 
$this->echoCorrectAnswer($bInCorrection, 'T1');				
echo '<input type="text" ';

echo ' name="T1" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T1')).'">';
?><br><br>2. She keeps her eggs in the refrigerator so that they don't go bad.  <?php 
$this->echoCorrectAnswer($bInCorrection, 'T2');				
echo '<input type="text" ';

echo ' name="T2" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T2')).'">';
?><br><br>3. Because he has problems with his hearing, James always sits in the front row of movie theaters.  <?php 
$this->echoCorrectAnswer($bInCorrection, 'T3');				
echo '<input type="text" ';

echo ' name="T3" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T3')).'">';
?><br><br>4. If you buy a sports car, you will have to pay more for your insurance.  <?php 
$this->echoCorrectAnswer($bInCorrection, 'T4');				
echo '<input type="text" ';

echo ' name="T4" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T4')).'">';
?><br><br>5. After the party, Sylvia was very tired.  <?php 
$this->echoCorrectAnswer($bInCorrection, 'T5');				
echo '<input type="text" ';

echo ' name="T5" value="'.htmlspecialchars($this->GetValue($bInCorrection, 'T5')).'">';
?><br><br>6. Although Simon is on vacation right now, he will start working on the new project in two days.  <?php 
