...
EpiLang.GoBackToEndPage = "Go back to the end page";
...
EpiLang.EnterPasswdString = "Please enter the questionnaire's password:";

EpiLang.TimerFinished = "No time left!";
EpiLangJS.ItIsNotAllowedToGoBack = "You are not allowed to go back!";
EpiLangJS.TheQuizzIsFinished = "The questionnaire is finished...!";
...
EpiLangJS.YouHaveReachTheLastPageButHanventAnsweredAllQuestions = "You have reached the last page, but have not answered all the questions. Do you want to end the questionnaire now ?";
EpiLangJS.YouHanventAnsweredAllQuestions = "You have not answered all the questions. Do you want to end the questionnaire now ?";
EpiLangJS.DoYouWantToEndTheQuestionnaireNow = "Do you want to end the questionnaire now ?";
EpiLang.EndTheQuestionnaireNow = "- End the questionnaire now -";
