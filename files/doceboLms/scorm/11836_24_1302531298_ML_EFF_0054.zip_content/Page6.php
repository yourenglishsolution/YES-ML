	...
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function GetQuestionsArray()
		{
			...
			$ret[] = array('correct' => false,
									   'html' => "His calculations were incorrect."
			);			
			
			$ret[] = array('correct' => true,
									   'html' => "He wanted to find a western route to the Orient."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "He thought the earth was flat."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "He wanted to find people to enslave."
			);			
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Why did Columbus sail west?</i></td>
</tr>
<tr class="Question_text">
...
<td valign="top" class="Question_answers ProcessInlineImages">His calculations were incorrect. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
...
<td valign="top" class="Question_answers ProcessInlineImages">He wanted to find a western route to the Orient. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow1">
...
<td valign="top" class="Question_answers ProcessInlineImages">He thought the earth was flat. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers" valign="top" align="center" width="50"><?$this->echoCorrectAnswer($bInCorrection, 3); ?><input id="Q4" type="radio" name="QCU" value="3" <?=$this->IsSelected($bInCorrection, 3) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">He wanted to find people to enslave. </td><td valign="top" class="Question_answers">
</td>
</tr>
</table></p>
