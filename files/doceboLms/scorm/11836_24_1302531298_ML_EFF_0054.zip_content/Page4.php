	...
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function GetQuestionsArray()
		{
			...
			$ret[] = array('correct' => false,
									   'html' => "because Spain bought the Americas"
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "because Columbus became Spanish when he got married"
			);			
			
			$ret[] = array('correct' => true,
									   'html' => "because Spain financed Columbus' voyage"
			);			
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Columbus was not Spanish and yet the Spanish also celebrate Columbus day.  Why?</i></td>
</tr>
<tr class="Question_text">
...
<td valign="top" class="Question_answers ProcessInlineImages">because Spain bought the Americas </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
...
<td valign="top" class="Question_answers ProcessInlineImages">because Columbus became Spanish when he got married </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow1">
...
<td valign="top" class="Question_answers ProcessInlineImages">because Spain financed Columbus' voyage </td><td valign="top" class="Question_answers">
</td>
</tr>
</table></p>
