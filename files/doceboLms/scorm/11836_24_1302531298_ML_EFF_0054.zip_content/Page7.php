	...
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function GetQuestionsArray()
		{
			...
			$ret[] = array('correct' => false,
									   'html' => "he didn't have enough food left on the boats for them to return with him"
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "to tame the natives"
			);			
			
			$ret[] = array('correct' => true,
									   'html' => "to start a colony"
			);			
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Why did Columbus leave some men behind in the New World on his first voyage?</i></td>
</tr>
<tr class="Question_text">
...
<td valign="top" class="Question_answers ProcessInlineImages">he didn't have enough food left on the boats for them to return with him </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
...
<td valign="top" class="Question_answers ProcessInlineImages">to tame the natives </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow1">
...
<td valign="top" class="Question_answers ProcessInlineImages">to start a colony </td><td valign="top" class="Question_answers">
</td>
</tr>
</table></p>
