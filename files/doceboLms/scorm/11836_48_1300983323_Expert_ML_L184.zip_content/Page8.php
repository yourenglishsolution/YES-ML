		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				{				
					...
					$AnswerText .=	"<tr>";
					$AnswerText .=	"<td class=\"Correction\" ><li>to stage a comeback<br></td>";

					

					$AnswerText .=	"<td class=\"Correction\" ><li>If we put more money into advertising, I'm sure we can return to our former place in the market.</td>";
					...
					$AnswerText .=	"<tr>";
					$AnswerText .=	"<td class=\"Correction\" ><li>to have a nest egg</td>";

					

					$AnswerText .=	"<td class=\"Correction\" ><li>I've got a little money put aside for emergencies like this.</td>";
					...
					$AnswerText .=	"<tr>";
					$AnswerText .=	"<td class=\"Correction\" ><li>to squirrel away</td>";

					

					$AnswerText .=	"<td class=\"Correction\" ><li>She's been putting money in a number of savings accounts for years.</td>";
...
<td class="Question_text ProcessInlineImages" valign="top">Drag the sentence on the right to the expressions on the left.</td>
</tr>
<tr class="Question_text">
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td valign="top" align="center" class="ProcessInlineImages">to stage a comeback<br></td>
</tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td valign="top" align="center" class="ProcessInlineImages">to have a nest egg</td>
</tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td valign="top" align="center" class="ProcessInlineImages">to squirrel away</td>
</tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td valign="top" align="center" class="ProcessInlineImages">I've got a little money put aside for emergencies like this.</td>
</tr>
</table>
</td></tr></table>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td valign="top" align="center" class="ProcessInlineImages">She's been putting money in a number of savings accounts for years.</td>
</tr>
</table>
</td></tr></table>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td valign="top" align="center" class="ProcessInlineImages">If we put more money into advertising, I'm sure we can return to our former place in the market.</td>
</tr>
</table>
</td></tr></table>
</td>
