	...
	class QuestionDisplayer extends QuestionDisplayerBase
	{
		...
		function GetQuestionsArray()
		{
			...
			$ret[] = array('correct' => false,
									   'html' => "The customer ate all the food."
			);			
			
			$ret[] = array('correct' => true,
									   'html' => "The manager doesn't agree that the food was badly cooked."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "The customer never asked the waiter to bring the food back to the kitchen."
			);			
			
			$ret[] = array('correct' => false,
									   'html' => "The manager wants the customer to come back again."
			);			
...
<td class="Question_text ProcessInlineImages" valign="top">[[snd:C1_W37_D4_complaint1.mp3]]<br><br>Why does the manager want the customer to pay?</td>
</tr>
<tr class="Question_text">
...
<tr class="AnswerRow1">
<td class="Question_answers" valign="top" align="center" width="30"><input id="Q1" type="radio" name="QCU" value="0" <?=$this->IsSelected($bInCorrection, 0) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">The customer ate all the food. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers" valign="top" align="center" width="30"><input id="Q2" type="radio" name="QCU" value="1" <?=$this->IsSelected($bInCorrection, 1) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">The manager doesn't agree that the food was badly cooked. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers" valign="top" align="center" width="30"><input id="Q3" type="radio" name="QCU" value="2" <?=$this->IsSelected($bInCorrection, 2) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">The customer never asked the waiter to bring the food back to the kitchen. </td><td valign="top" class="Question_answers">
</td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers" valign="top" align="center" width="30"><input id="Q4" type="radio" name="QCU" value="3" <?=$this->IsSelected($bInCorrection, 3) ?> ></td>
<td valign="top" class="Question_answers ProcessInlineImages">The manager wants the customer to come back again. </td><td valign="top" class="Question_answers">
</td>
</tr>
</table></p>
...
<td valign="top"><img src="_images/t.gif" width="1" height="1"></td>
  ...
  bDontScrollDraggables = true;
	...
	myQuizz.AnswersWeight[0][0] = -1 -0;
	
	myQuizz.RightAnswer[0][1] = true;
	myQuizz.AnswersWeight[0][1] = -1 -0;
	
	myQuizz.RightAnswer[0][2] = false;
	myQuizz.AnswersWeight[0][2] = -1 -0;
	
	myQuizz.RightAnswer[0][3] = false;
	myQuizz.AnswersWeight[0][3] = -1 -0;
