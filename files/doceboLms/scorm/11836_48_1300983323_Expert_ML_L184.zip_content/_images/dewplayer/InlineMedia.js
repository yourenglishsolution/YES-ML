			...
			for(var i = 0; i < AvailableMedia.length; i++)
			{
				switch (GetFileType(AvailableMedia[i]))
				{
					...
					case 'mp3':
						regularexpression = new RegExp("\\[\\[snd:" + AvailableMedia[i] + "\\]\\]", 'gi') ;
						str = str.replace(regularexpression,
								'<object type="application/x-shockwave-flash" data="_images/dewplayer/dewplayer.swf" width="393" height="40">'
					...
					case 'flash':
						...
						str = str.replace(regularexpression,
								...
								+'  <!--<![endif]-->'
								+'    <embed src="_attachments/@@InlineImage@@" type="application/x-shockwave-flash" quality="autohigh" wmode="opaque" width="$1" height="$2"></embed>'
								+'  <!--[if !IE]>-->'
								+'    </object>'
								+'  <!--<![endif]-->'
								+'</object>'
						...
						str = str.replace(regularexpression,
								...
								+'  		<param name="play" value="True"></param>'
								+'  <!--<![endif]-->'
								+'    <embed width="550" height="400" src="_attachments/@@InlineImage@@" type="application/x-shockwave-flash" quality="autohigh" wmode="opaque"></embed>'
								+'  <!--[if !IE]>-->'
								+'    </object>'
								+'  <!--<![endif]-->'
								+'</object>'
