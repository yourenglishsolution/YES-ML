...
class QuestionDisplayerBase
{
 														 ...
 														 &$ScoreTable)
	{
		...
		if (empty($ScoreTable['Total']['TimeMax']))
		{
	...
	function AddQuestionsToPageMapping($targetGuid)
	{
		...
		for ($i = 0; $i < count($_SESSION['QuizzSession']['PageMapping']); $i++)
		{
			...
			$_SESSION['QuizzSession']['PageData'][] = array(
					'originalId' => $_SESSION['QuizzSession']['PageMapping'][$i],
					'uid' => $this->GetPageData($i, 'uid'),
					'Answers' => array(),
					'Score' => 0,
					'TempScore' => -1,
					'Time' => 0,
					'Tries' => 0,
					'HintCycle' => $this->ShowAnswerAfterQuestion == 'true' ? 2 : 0,
					'Disabled' => false,
					'ShowAnswers' => false,
					'LoadingTime' => false,
					'TimeMax' => 0,
