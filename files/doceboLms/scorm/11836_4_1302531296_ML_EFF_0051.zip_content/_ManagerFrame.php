...
class QuizzManager extends QuizzManagerBase
{
	function QuizzManager()
	{
		...
		$this->QuestionDefinition["6W2TU"] = array(
			"Title" => "Word of the day",	
			"Type" => "EXPLANATION");
		$this->QuestionDefinition["XK8PE"] = array(
			"Title" => "Expressions",	
			"Type" => "EXPLANATION");
		$this->QuestionDefinition["X38AA"] = array(
			"Title" => "Q1",	
			"Type" => "MATCH");
		$this->QuestionDefinition["B3CT5"] = array(
			"Title" => "Q2",	
			"Type" => "TAT");
		$this->QuestionDefinition["5AD7G"] = array(
			"Title" => "The end",	
			"Type" => "EXPLANATION");



		$this->GenerationDate = "01.04.2011 17:50:54";
