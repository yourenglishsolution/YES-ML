		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "talk is ____ &rarr; cheap<br>____ talk &rarr; pep<br>all talk and no ____ &rarr; trousers<br>talk of the ____ &rarr; town<br>";
				}
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Complete the expressions with the missing word.</i></td>
</tr>
<tr class="Question_text">
