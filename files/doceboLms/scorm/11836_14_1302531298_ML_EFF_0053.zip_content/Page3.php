		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "talk is ____ &rarr; cheap<br>talk out the back of your ____ &rarr; head<br>all talk and no ____ &rarr; trousers<br>talking to a brick ____ &rarr; wall<br>";
				}
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Complete the expressions with the missing words.</i></td>
</tr>
<tr class="Question_text">
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">talk is ____ </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M1'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M1"><option value="" <?=$this->IsSelected($bInCorrection, "M1", "")?> ></option><option value="cheap" <?=$this->IsSelected($bInCorrection, "M1", "cheap")?> >cheap</option><option value="head" <?=$this->IsSelected($bInCorrection, "M1", "head")?> >head</option><option value="trousers" <?=$this->IsSelected($bInCorrection, "M1", "trousers")?> >trousers</option><option value="wall" <?=$this->IsSelected($bInCorrection, "M1", "wall")?> >wall</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">talk out the back of your ____ </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M2'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M2"><option value="" <?=$this->IsSelected($bInCorrection, "M2", "")?> ></option><option value="cheap" <?=$this->IsSelected($bInCorrection, "M2", "cheap")?> >cheap</option><option value="head" <?=$this->IsSelected($bInCorrection, "M2", "head")?> >head</option><option value="trousers" <?=$this->IsSelected($bInCorrection, "M2", "trousers")?> >trousers</option><option value="wall" <?=$this->IsSelected($bInCorrection, "M2", "wall")?> >wall</option></select></td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">all talk and no ____ </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M3'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M3"><option value="" <?=$this->IsSelected($bInCorrection, "M3", "")?> ></option><option value="cheap" <?=$this->IsSelected($bInCorrection, "M3", "cheap")?> >cheap</option><option value="head" <?=$this->IsSelected($bInCorrection, "M3", "head")?> >head</option><option value="trousers" <?=$this->IsSelected($bInCorrection, "M3", "trousers")?> >trousers</option><option value="wall" <?=$this->IsSelected($bInCorrection, "M3", "wall")?> >wall</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">talking to a brick ____ </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M4'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M4"><option value="" <?=$this->IsSelected($bInCorrection, "M4", "")?> ></option><option value="cheap" <?=$this->IsSelected($bInCorrection, "M4", "cheap")?> >cheap</option><option value="head" <?=$this->IsSelected($bInCorrection, "M4", "head")?> >head</option><option value="trousers" <?=$this->IsSelected($bInCorrection, "M4", "trousers")?> >trousers</option><option value="wall" <?=$this->IsSelected($bInCorrection, "M4", "wall")?> >wall</option></select></td>
</tr>
</table></p>
