...
if ($GLOBALS['ClassToInstanciate'] == 'QuestionManager')
{
	class QuestionManager
	{
		...
		function QuestionManager()
		{
			...
			$this->Answer[0] = "to move quickly";
			
			$this->Answer[1] = "in reality";
			
			$this->Answer[2] = "to cook just below the boiling point";
		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "haste &rarr; to move quickly<br>indeed &rarr; in reality<br>simmer &rarr; to cook just below the boiling point<br>";
				}
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Match the word to the correct definition.</i></td>
</tr>
<tr class="Question_text">
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">haste </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M1'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M1"><option value="" <?=$this->IsSelected($bInCorrection, "M1", "")?> ></option><option value="in reality" <?=$this->IsSelected($bInCorrection, "M1", "in reality")?> >in reality</option><option value="to cook just below the boiling point" <?=$this->IsSelected($bInCorrection, "M1", "to cook just below the boiling point")?> >to cook just below the boiling point</option><option value="to move quickly" <?=$this->IsSelected($bInCorrection, "M1", "to move quickly")?> >to move quickly</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">indeed </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M2'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M2"><option value="" <?=$this->IsSelected($bInCorrection, "M2", "")?> ></option><option value="in reality" <?=$this->IsSelected($bInCorrection, "M2", "in reality")?> >in reality</option><option value="to cook just below the boiling point" <?=$this->IsSelected($bInCorrection, "M2", "to cook just below the boiling point")?> >to cook just below the boiling point</option><option value="to move quickly" <?=$this->IsSelected($bInCorrection, "M2", "to move quickly")?> >to move quickly</option></select></td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">simmer </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M3'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M3"><option value="" <?=$this->IsSelected($bInCorrection, "M3", "")?> ></option><option value="in reality" <?=$this->IsSelected($bInCorrection, "M3", "in reality")?> >in reality</option><option value="to cook just below the boiling point" <?=$this->IsSelected($bInCorrection, "M3", "to cook just below the boiling point")?> >to cook just below the boiling point</option><option value="to move quickly" <?=$this->IsSelected($bInCorrection, "M3", "to move quickly")?> >to move quickly</option></select></td>
</tr>
</table></p>
