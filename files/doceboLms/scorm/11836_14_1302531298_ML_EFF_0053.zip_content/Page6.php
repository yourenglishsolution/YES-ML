		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">George Washington was the second president of the United States.</td>";
					...
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">George Washington was in the military.</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					...
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">George Washington was born in Washington.</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					...
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">North Carolina's state slogan is the 'First in Flight'.</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
					...
					$AnswerText .= "</td></tr>";
					$AnswerText .= "";
					$AnswerText .= "<tr><td class=\"Correction\" valign=\"top\">California has the largest land-locked harbor.</td>";
					$AnswerText .= "<td class=\"Correction\" valign=\"top\" align=\"center\">";
					$AnswerText .= "";
					$AnswerText .= "";
					$AnswerText .= "";
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Are the statements true or false?</i></td>
</tr>
<tr class="Question_text">
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">George Washington was the second president of the United States.</td>
...
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">George Washington was in the military.</td>
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">George Washington was born in Washington.</td>
...
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">North Carolina's state slogan is the 'First in Flight'.</td>
...
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">California has the largest land-locked harbor.</td>
