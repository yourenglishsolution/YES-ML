...
if ($GLOBALS['ClassToInstanciate'] == 'QuestionManager')
{
	class QuestionManager
	{
		...
		function QuestionManager()
		{
			...
			$this->Answer[0] = "a government grant giving the holder a exclusive right to produce a specific invention";
			
			$this->Answer[1] = "for all eternity";
			
			$this->Answer[2] = "something just invented";
			
			$this->Answer[3] = "capable of being done";
		...
		function PrintCorrection($bInCorrection)
		{
			if ($bInCorrection)
			{
				...
				if ($Score != $ScoreMax)
				{
					...
					$AnswerText .= "patent &rarr; a government grant giving the holder a exclusive right to produce a specific invention<br>posterity &rarr; for all eternity<br>newfangled &rarr; something just invented<br>feasible &rarr; capable of being done<br>";
				}
...
<td class="Question_text ProcessInlineImages" valign="top"><i>Match the words with the correct definitions.</i></td>
</tr>
<tr class="Question_text">
...
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M1'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M1"><option value="" <?=$this->IsSelected($bInCorrection, "M1", "")?> ></option><option value="a government grant giving the holder a exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M1", "a government grant giving the holder a exclusive right to produce a specific invention")?> >a government grant giving the holder a exclusive right to produce a specific invention</option><option value="capable of being done" <?=$this->IsSelected($bInCorrection, "M1", "capable of being done")?> >capable of being done</option><option value="for all eternity" <?=$this->IsSelected($bInCorrection, "M1", "for all eternity")?> >for all eternity</option><option value="something just invented" <?=$this->IsSelected($bInCorrection, "M1", "something just invented")?> >something just invented</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">posterity </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M2'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M2"><option value="" <?=$this->IsSelected($bInCorrection, "M2", "")?> ></option><option value="a government grant giving the holder a exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M2", "a government grant giving the holder a exclusive right to produce a specific invention")?> >a government grant giving the holder a exclusive right to produce a specific invention</option><option value="capable of being done" <?=$this->IsSelected($bInCorrection, "M2", "capable of being done")?> >capable of being done</option><option value="for all eternity" <?=$this->IsSelected($bInCorrection, "M2", "for all eternity")?> >for all eternity</option><option value="something just invented" <?=$this->IsSelected($bInCorrection, "M2", "something just invented")?> >something just invented</option></select></td>
</tr>
<tr class="AnswerRow1">
<td class="Question_answers ProcessInlineImages">newfangled </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M3'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M3"><option value="" <?=$this->IsSelected($bInCorrection, "M3", "")?> ></option><option value="a government grant giving the holder a exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M3", "a government grant giving the holder a exclusive right to produce a specific invention")?> >a government grant giving the holder a exclusive right to produce a specific invention</option><option value="capable of being done" <?=$this->IsSelected($bInCorrection, "M3", "capable of being done")?> >capable of being done</option><option value="for all eternity" <?=$this->IsSelected($bInCorrection, "M3", "for all eternity")?> >for all eternity</option><option value="something just invented" <?=$this->IsSelected($bInCorrection, "M3", "something just invented")?> >something just invented</option></select></td>
</tr>
<tr class="AnswerRow0">
<td class="Question_answers ProcessInlineImages">feasible </td>
<td class="Question_answers" valign="middle"><?php $this->echoCorrectAnswer($bInCorrection, 'M4'); ?><select onclick="resetAllCombos(this);" size="1" class="TAT_Selects" name="M4"><option value="" <?=$this->IsSelected($bInCorrection, "M4", "")?> ></option><option value="a government grant giving the holder a exclusive right to produce a specific invention" <?=$this->IsSelected($bInCorrection, "M4", "a government grant giving the holder a exclusive right to produce a specific invention")?> >a government grant giving the holder a exclusive right to produce a specific invention</option><option value="capable of being done" <?=$this->IsSelected($bInCorrection, "M4", "capable of being done")?> >capable of being done</option><option value="for all eternity" <?=$this->IsSelected($bInCorrection, "M4", "for all eternity")?> >for all eternity</option><option value="something just invented" <?=$this->IsSelected($bInCorrection, "M4", "something just invented")?> >something just invented</option></select></td>
</tr>
</table></p>
