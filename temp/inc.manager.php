...
class QuizzManagerBase
{
	...
	function LoadPersistentData()
	{
		...
		$url = 'http://' . $_SERVER['HTTP_HOST'] . '/doceboLms/modules/scorm/EQP_ScormLoadSession.php';
	...
	function SendScorm()
	{
		...
		if ($_SESSION['QuizzSession']['TotalScore'] != -1) {
			...
			echo '	window.parent.sendAnswer("'.str_replace(',', '.', addslashes(serialize($_SESSION['QuizzSession']))) .'");' . "\n";
		}
		else
