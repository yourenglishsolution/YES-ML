...
define("_INSTALLER_TITLE", "Installer - Docebo 4.0");
...
define("_SETUP_COMPLETE", "Installazione completata");
...
define("_SOFTWARE_LICENSE", "Licenza software degli applicativi Docebo");
...
define("_DOMXML_REQUIRED", "Per installare la suite Docebo &egrave; necessario che sia installato il modulo domxml o PHP 5 o successivo.");
...
define("_INSTALLER_INTRO_TEXT", "Docebo &egrave; una realt&agrave; italiana che ha sviluppato, in collaborazione con le pi&ugrave; grandi societ&agrave; e universit&agrave; il suo sistema open-source per l'e-learning (LMS e LCMS) per la formazione in ambiente enterprise ed universitario.
...
define("_VERSION","Versione Docebo");
define("_START","Iniziale");
define("_END","Finale");
define("_INVALID_CONFIG_FILE", "File config.php non valido; assicurati che sia della versione 3.6.x");
