...
function view_report_certificate() {
	...
	if ($numrows > 0)
	{
		...
		$form = new Form();
		$out->add($form->openForm("certificates_emission", "index.php?modname=certificate&amp;op=view_report_certificate&amp;id_certificate=".(int)$id_certificate."&amp;id_course=".(int)$id_course)
	...
	Util::get_js(Get::rel_path('lms').'/admin/modules/certificate/certificate.js', true, true);
