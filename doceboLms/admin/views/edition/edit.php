...
echo	Form::openForm('add_edition_form', 'index.php?r='.$base_link_edition.'/edit&amp;id_course='.$model->getIdCourse().'&amp;id_edition='.$model->getIdEdition())
		...
		.Form::getDatefield(Lang::t('_DATE_BEGIN', 'course'), 'date_begin', 'date_begin', Format::date($edition_info['date_begin'], 'date'))
		.Form::getDatefield(Lang::t('_DATE_END', 'course'), 'date_end', 'date_end', Format::date($edition_info['date_end'], 'date'))
		...
		.'</div>'
		.Form::getDatefield(Lang::t('_SUBSCRIPTION_DATE_BEGIN', 'course'), 'sub_date_begin', 'sub_date_begin', Format::date($edition_info['sub_date_begin'], 'date'))
		.Form::getDatefield(Lang::t('_SUBSCRIPTION_DATE_END', 'course'), 'sub_date_end', 'sub_date_end', Format::date($edition_info['sub_date_end'], 'date'))
