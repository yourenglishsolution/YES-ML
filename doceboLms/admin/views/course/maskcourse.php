...
if($course['course_type'] != 'elearning' && $has_classroom) {
	
	echo Form::getLineBox(Lang::t('_COURSE_TYPE', 'course'), $course['course_type'])
...
echo Form::getDropdown(Lang::t('_STATUS', 'course'), 'course_status', 'course_status', $status, $course['status'])
	...
	. Form::getExtendedFilefield(Lang::t('_SPONSOR_LOGO', 'course'), 'course_sponsor_logo', 'course_sponsor_logo', $course["imgSponsor"])
