...
function defmodality() {
	...
	list($title, $description, $display_type, $order_type, $shuffle_answer, $question_random_number, 
		...
		$order_info, $use_suspension, $suspension_num_attempts, $suspension_num_hours, $suspension_prerequisites, $chart_options, $mandatory_answer
...
/*
			.'<br />'
			.Form::getCheckbox($lang->def('_USE_CHART'), 'use_charts', 'use_charts', 1, $chart_options_decoded->use_charts)
			.Form::getRadioSet($lang->def('_SELECT_CHART'), 'selected_chart', 'selected_chart', $chart_list, $chart_options_decoded->selected_chart)
			.Form::getRadioSet($lang->def('_SHOWMODE_CHART'), 'show_mode', 'show_mode', $chart_show, $chart_options_decoded->show_mode)
*/
		//--------------------------------------------------------------------------
...
function updatemodality() {
	...
	$chart_options->use_charts = (bool)Get::req('use_charts', DOTY_INT, 0);
	$chart_options->selected_chart = Get::req('selected_chart', DOTY_STRING, '');
	$chart_options->show_chart = Get::req('show_chart', DOTY_STRING, 'teacher');
	...
	." ,chart_options = '".$json->encode($chart_options)."' "
	." WHERE idTest = '$idTest'")) {
		errorCommunication($lang->def('_OPERATION_FAILURE')
